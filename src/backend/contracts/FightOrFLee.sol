...
contract NewTokenExample is ERC721, Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    //Constructor **************************************************************************************
    constructor(uint64 subscriptionId) ERC721("NewTokenExample", "MTK") {
    ...
    event RandomNumberRequestComplete(address sender, uint256 callbackFunction, uint256 param1, uint256 param2, uint256 param3);
    ...
    function spawn() public payable nonReentrant(){
        ...
        requestRandomNumber(RandomNumberRequest(msg.sender, 0, tokenId, 0, 0));
    }
    ...
    function fulfillRandomWords(
        ...
        emit RandomNumberRequestComplete(lastRandomNumberRequest.sender, lastRandomNumberRequest.callbackFunction, lastRandomNumberRequest.param1, lastRandomNumberRequest.param2, lastRandomNumberRequest.param3);
